...
if [[ -n $(xsetwacom --list devices) ]]; then
    ...
    xsetwacom set "HUION Huion Tablet Pen stylus" "Suppress" "4" # default = 2
    xsetwacom set "HUION Huion Tablet Pad pad" "Threshold" "50"
    xsetwacom set "HUION Huion Tablet Pad pad" "RawSample" "1" # default = 4
    xsetwacom set "HUION Huion Tablet Pad pad" "Suppress" "4" # default = 2
